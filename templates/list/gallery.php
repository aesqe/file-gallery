...
<?php if( ! empty($link) ) :
?><a href="<?php echo $link; ?>" title="<?php echo $title; ?>" class="gallery-icon<?php if( ! empty($link_class) ){ echo ' ' . $link_class; } ?>"<?php if( ! empty($rel) ) : ?> rel="<?php echo $rel; ?>"<?php endif; ?>><?php endif; ?><?php
	echo $title;
?><?php if( ! empty($link) ) : 
?></a>
<?php endif; ?>
